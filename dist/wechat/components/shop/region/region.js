"use strict";
(wx["mor_modules"] = wx["mor_modules"] || []).push([["components/shop/region/region"],{

/***/ "./components/shop/region/region.ts":
/*!******************************************!*\
  !*** ./components/shop/region/region.ts ***!
  \******************************************/
...
/* harmony import */ var _assets_province_city_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../assets/province-city.json */ "./assets/province-city.json");
...
var generateTree = function (list) {
    return list.map(function (item) { return ((0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)({}, item), { label: item.name, value: item.name, children: generateTree(item.children || []) })); });
};
(0,_ali_mor_core__WEBPACK_IMPORTED_MODULE_0__.aComponent)({
    ...
    data: {
        options: generateTree(_assets_province_city_json__WEBPACK_IMPORTED_MODULE_1__),
        value: [,],
    },
    methods: {
        onChange: function (e) {
...
/******/ __webpack_require__.O(0, ["mor.v"], function() { return __webpack_exec__("./components/shop/region/region.ts"); });
